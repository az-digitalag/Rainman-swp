...
load("models/v3/inits/inits.Rdata")
...
# Intialize model
jm <- jags.model(file = "models/v3/VG_hierarchy.jags",
                 data = dat_list,
                 inits = saved_state[[2]],
                 n.chains = 3)
...
# save(jm_coda, file = "models/v3/coda/jm_coda.Rdata")
...
saved_state <- removevars(initsin = newinits, 
                          variables = c(1:4, 8:12, 17))
saved_state[[1]]
save(saved_state, file = "models/v3/inits/inits.Rdata") #for local
...
save(jm_rep, file = "models/v3/coda/jm_rep.Rdata")
